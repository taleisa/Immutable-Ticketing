...
class EventHost:
    ...
    def mintTicket(self, nft_contract, ticket_URI, ticket_price, ticket_seat_number, ticket_class):
        #create nft_contract by querying the database and retreiving the contract address
        nft_contract.functions.safeMint(EventHost.GEA,ticket_URI,ticket_price,ticket_seat_number, ticket_class).transact({"from": EventHost.GEA})    
